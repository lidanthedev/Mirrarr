...
def main():
    ...
    burp0_base_url = "https://www.rivestream.app:443/api/backendfetch"
    burp0_params = {
    ...
    # burp0_headers = {"Sec-Ch-Ua-Platform": "\"Linux\"", "Accept-Language": "en-GB,en;q=0.9", "Accept": "application/json", "Sec-Ch-Ua": "\"Not_A Brand\";v=\"99\", \"Chromium\";v=\"142\"", "User-Agent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36", "Sec-Ch-Ua-Mobile": "?0", "Sec-Fetch-Site": "same-origin", "Sec-Fetch-Mode": "cors", "Sec-Fetch-Dest": "empty", "Referer": "https://www.rivestream.app/watch?type=tv&id=1418&season=1&episode=1", "Accept-Encoding": "gzip, deflate, br", "Priority": "u=1, i"}
