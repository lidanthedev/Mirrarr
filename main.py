...
def main():
    ...
    burp0_url = "https://rivestream.org:443/api/backendfetch?requestID=tvVideoProvider&id=1418&season=1&episode=1&service=flowcast&secretKey=NGFmNjhjZDg=&proxyMode=noProxy"
